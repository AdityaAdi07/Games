...
class CarPoolApp:
    def __init__(self, master, car_pool_system):
        ...
        style.configure("TButton", foreground="white", background="#4CAF50", font=('Arial', 12), relief="raised",
                        borderwidth=2)
        ...
        search_frame = ttk.Frame(search_tab, padding="10", style='TFrame')
        search_frame.pack()

        self.label_pickup = ttk.Label(search_frame, text="Enter pickup location:", font=('Arial', 12),
        ...
        self.label_drop = ttk.Label(search_frame, text="Enter drop location:", font=('Arial', 12), background='#1E90FF',
                                    foreground='white')
        ...
        table_frame = ttk.Frame(results_tab, style='TFrame')
